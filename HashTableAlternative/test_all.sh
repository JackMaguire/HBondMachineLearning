...
for x in 15 20 25 50; do
    ...
    java EvaluateTable temp.${aa1}_${aa2}.dat /nas/longleaf/home/jackmag/pine/tensorflow_hbonds/randomly_generated_data/${aa1}_${aa2}/testing.dat /nas/longleaf/home/jackmag/pine/tensorflow_hbonds/native_data/$aa1.$aa2.native.csv
done | sort -gk6 | tail -n1 | awk '{print $6}'
